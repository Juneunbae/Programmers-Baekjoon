'''
    ...
    약관 종류는 여러 가지 있으며 각 약관마다 개인정보 보관 유효기간이 정해져 있습니다. 당신은 각 개인정보가 어떤 약관으로 수집됐는지 알고 있습니다. 
...
def solution(today, terms, privacies) :
    ...
    for i, p in enumerate(privacies) :
        p_date, p_plus_month = p.split(" ")
    
        p_date_year, p_date_month, p_date_day = map(int, p_date.split("."))

        p_plus_month = dict_terms[p_plus_month]
        p_date_month += p_plus_month

        while p_date_month > 12:
            p_date_year += 1
            p_date_month -= 12
        
        date = p_date_year * 10000 + p_date_month * 100 + p_date_day
